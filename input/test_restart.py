...
restart = True 
restart_step = 10000
restart_path = "./test_restart"
if (restart) :
   beam = load_beam(restart_path+"/beam/"+str(restart_step), restart_step, mpi_rank)
   num_particles = beam.shape[0] 
else :
...
beam_output_interval = 10000 #num_step - 1
