...
run_name = "test_beam_g10_l3000"

## electron and trajectory
gamma=10
lbeam = 3000    # beam length, in um
dbeam = 200     # beam radius, in um
psi_max = 0.6   # max retarded 
...
npt_chi = 51  #101   # number of mesh points along chi
...
num_dirs = 200                     # number of field lines
...
# load wavelets
cosyr_root = '..'
path2subcycling = cosyr_root + "/input/wavelets/g10-3000x200um-sub"
