...
run_name = "test_beam_g100_l200_sub_10000x100"
...
num_dirs =  2                      # number of field lines
...
remap_scaling[0] = 5.0             # support/smoothing length scaling factor
remap_scaling[1] = 5.0             # support/smoothing length scaling factor
...
# load wavelets
cosyr_root = '..'
bench_data = "/global/cfs/cdirs/m3757/cosyr_benchmark"
path2subcycling = bench_data + "/wavelets/g100-200x200um-sub_10000x100_clip_pm200"

wavelet_x, wavelet_y, wavelet_field = load_wavelets(path2subcycling,
                                                    X_coord_file="scaled_xprime_sub.npy",
                                                    Y_coord_file="scaled_yprime_sub.npy",
                                                    fld_file="EBRad_sub.npy",
                                                    unscale_coord=True,
                                                    _gamma = gamma,
                                                    broadcast=False)
if (mpi_rank==0) :
