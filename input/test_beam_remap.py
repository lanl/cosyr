...
npt_alpha = 51 #1001  # number of mesh points along alpha
...
## load wavelets
wavelet_x, wavelet_y, wavelet_field = gen_test_wavelets(scaled_alpha*2, scaled_chi*2, (npt_alpha-1)*wpc[0]*2+2, (npt_chi-1)*wpc[1]*2+1, gamma, unscale_coord=True)
if (mpi_rank==0) :
